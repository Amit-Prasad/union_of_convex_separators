...
def rf_run(data_name):
    ...
    #parameters = {'n_estimators' : [1], 'min_samples_split' : [10], 'max_features' : [None], 'max_samples' : [0.6]} #best
    #parameters = {'n_estimators' : [1,2,3,4,5,6], 'min_samples_split' : [5, 10, 15, 20, 25, 30], 'max_features' : ('sqrt', 'log2', None), 'max_samples' : [0.2, 0.4, 0.5, 0.6]}
    #parameters = {'n_estimators' : [60, 70, 80, 90, 100, 110, 120], 'min_samples_split' : [2, 3, 4, 5, 10], 'max_features' : ('sqrt', 'log2', None), 'max_samples' : [0.2, 0.4, 0.5, 0.6]}
    parameters = {'n_estimators' : [130, 150, 170, 190, 210, 220, 230, 250], 'min_samples_split' : [2, 3, 4, 5, 10], 'max_features' : ('sqrt', 'log2', None), 'max_samples' : [0.2, 0.4, 0.5, 0.6]}
