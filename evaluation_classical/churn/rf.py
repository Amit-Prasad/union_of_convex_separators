...
def rf_run(data_name):
    ...
    parameters = {'n_estimators' : [6], 'min_samples_split' : [8], 'max_features' : [None], 'max_samples' : [0.2]} #best
    #parameters = {'n_estimators' : [15], 'min_samples_split' : [6], 'max_features' : [None], 'max_samples' : [0.8]}
    #parameters = {'n_estimators' : [5, 6, 7, 8, 9, 10], 'min_samples_split' : [5, 6, 7, 8, 9, 10], 'max_features' : ('sqrt', 'log2', None), 'max_samples' : [0.2, 0.4, 0.5, 0.6]}
    #telco
    #parameters = {'n_estimators' : [4, 5, 6, 7, 8], 'min_samples_split' : [10, 11, 12, 13, 14, 15], 'max_features' : ('sqrt', 'log2', None), 'max_samples' : [0.2, 0.4, 0.5, 0.6]}
    ...
    #best{'max_features': None, 'max_samples': 0.2, 'min_samples_split': 8, 'n_estimators': 6}
