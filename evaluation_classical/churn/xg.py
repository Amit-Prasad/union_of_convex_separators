...
def xg_run(data_name):
    ...
    parameters = {'n_estimators' : [16], 'max_depth' : [16], 'subsample' : [0.4]} #best
    #parameters = {'n_estimators' : [12, 14, 15, 16, 17], 'max_depth' : [6, 8, 10, 12, 14, 16], 'subsample' : [0.4, 0.5, 0.6, 0.7, 0.8]}
    #telco
    #parameters = {'n_estimators' : [16, 18, 20, 22, 24], 'max_depth' : [6, 8, 10, 12, 14, 16, 18], 'subsample' : [0.2, 0.3, 0.4, 0.5]}
