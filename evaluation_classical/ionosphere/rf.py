...
def rf_run(data_name):
    ...
    #best {'max_features': 'sqrt', 'max_samples': 0.6, 'min_samples_split': 2, 'n_estimators': 25}
    parameters = {'n_estimators' : [20, 25, 30, 35, 40, 45, 50], 'min_samples_split' : [2, 3, 5], 'max_features' : ('sqrt', 'log2', None), 'max_samples' : [0.2, 0.4, 0.5, 0.6]}
