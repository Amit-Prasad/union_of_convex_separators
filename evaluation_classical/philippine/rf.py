...
def rf_run(data_name):
    ...
    #parameters = {'n_estimators' : [65], 'min_samples_split' : [20], 'max_features' : [None], 'max_samples' : [0.6]} #best
    parameters = {'n_estimators' : [50, 55, 60, 65, 70, 75, 80, 85], 'min_samples_split' : [10, 15, 20, 25, 30], 'max_features' : ('sqrt', 'log2', None), 'max_samples' : [0.2, 0.4, 0.5, 0.6]}
