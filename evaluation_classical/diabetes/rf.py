...
def rf_run(data_name):
    ...
    #parameters = {'n_estimators' : [20, 25, 30, 35, 40], 'min_samples_split' : [2, 3, 5, 7, 9], 'max_features' : ('sqrt', 'log2', None), 'max_samples' : [0.2, 0.4, 0.5, 0.6]}
    parameters = {'n_estimators' : [15, 18, 20, 22, 25], 'min_samples_split' : [2, 3, 5, 7, 9], 'max_features' : ('sqrt', 'log2', None), 'max_samples' : [0.2, 0.4, 0.5, 0.6]}
    #parameters = {'n_estimators' : [20], 'min_samples_split' : [2], 'max_features' : ['sqrt'], 'max_samples' : [0.4]}#best
