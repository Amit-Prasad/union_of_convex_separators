...
def rf_run(data_name):
    ...
    #best parameters = {'n_estimators' : [85], 'min_samples_split' : [5], 'max_features' : ['log2'], 'max_samples' : [0.6]}
    #parameters = {'n_estimators' : [20, 40, 60, 80, 100], 'min_samples_split' : [2, 3, 5, 10, 15], 'max_features' : ('sqrt', 'log2', None), 'max_samples' : [0.2, 0.4, 0.5, 0.6, 0.8]}
    parameters = {'n_estimators' : [100, 120, 140, 160, 180, 200, 220], 'min_samples_split' : [2, 3, 5, 10, 15], 'max_features' : ('sqrt', 'log2', None), 'max_samples' : [0.2, 0.4, 0.5, 0.6, 0.8]}
