...
def rf_run(data_name):
    ...
    parameters = {'n_estimators' : [60], 'min_samples_split' : [3], 'max_features' : [None], 'max_samples' : [0.6]}
    #parameters = {'n_estimators' : [50, 55, 60, 65, 70], 'min_samples_split' : [2, 3, 4, 5], 'max_features' : ('sqrt', 'log2', None), 'max_samples' : [0.2, 0.4, 0.5, 0.6]}
    ...
    scores = cross_val_score(clf, data_x, data_y, n_jobs=-1, cv=5, scoring = 'balanced_accuracy')
