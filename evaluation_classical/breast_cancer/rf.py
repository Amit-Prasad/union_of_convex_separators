...
def rf_run(data_name):
    ...
    parameters = {'n_estimators' : [5, 10, 15, 20, 25], 'min_samples_split' : [2, 3, 5], 'max_features' : ('sqrt', 'log2', None), 'max_samples' : [0.2, 0.4, 0.5, 0.6]}
    #best {'max_features': None, 'max_samples': 0.6, 'min_samples_split': 3, 'n_estimators': 5}
